package com.warranty.gateway.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler implements ExceptionTranslation {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.warranty.gateway.service.EmailAlreadyUsedException ||
            ex instanceof com.warranty.gateway.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.warranty.gateway.service.InvalidPasswordException
